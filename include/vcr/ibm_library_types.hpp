/**
 * @brief lin_tape structs
 * @note See IBM Tape Device Drivers: Programming Reference
 *       https://www.ibm.com/support/pages/system/files/inline-files/$FILE/GA32-0566-09_0.pdf
 */
